            ...
            <div className="relative h-full rounded-xl border border-[#E5E5E5] dark:border-[#333333] p-0.5">
              ...
              <div
                ...
                className={classNames(
                  ...
                  isActive ? 'bg-gray-100 dark:bg-gray-900 ring-1 ring-gray-200 dark:ring-gray-800' : '',
              ...
              >
                ...
                <div
                  className={classNames(
                    ...
                    'group-hover:ring-gray-300 dark:group-hover:ring-gray-700/30',
                    'transition-all duration-100 ease-out',
                    isActive ? 'bg-gray-200 dark:bg-gray-800 ring-gray-300 dark:ring-gray-700' : '',
                  )}
                >
                  {(() => {
