              ...
              <>
                ...
                <div className="absolute right-0 top-full mt-2 z-50 min-w-[240px] max-h-[400px] overflow-y-auto bg-white dark:bg-black rounded-xl shadow-2xl border border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)] overflow-hidden">
                  <div className="p-3 border-b border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)]">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          className={`w-10 h-5 rounded-full transition-colors duration-200 ${
                            showDeviceFrame ? 'bg-black dark:bg-white' : 'bg-gray-300 dark:bg-gray-700'
                          } relative`}
                          onClick={(e) => {
                            e.stopPropagation();
                        ...
                        >
                          <span
                            className={`absolute top-0.5 left-0.5 w-4 h-4 rounded-full transition-all duration-200 ${
                              showDeviceFrame ? 'transform translate-x-5 bg-white dark:bg-black' : 'bg-white'
                            }`}
                          />
                        </button>
                      </div>
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          className={`w-10 h-5 rounded-full transition-colors duration-200 ${
                            isLandscape ? 'bg-black dark:bg-white' : 'bg-gray-300 dark:bg-gray-700'
                          } relative`}
                          onClick={(e) => {
                            e.stopPropagation();
                        ...
                        >
                          <span
                            className={`absolute top-0.5 left-0.5 w-4 h-4 rounded-full transition-all duration-200 ${
                              isLandscape ? 'transform translate-x-5 bg-white dark:bg-black' : 'bg-white'
                            }`}
                          />
                        </button>
                      </div>
                  ...
                  {WINDOW_SIZES.map((size) => (
                    <button
                      key={size.name}
                      className="w-full px-4 py-3.5 text-left text-[#111827] dark:text-gray-300 text-sm whitespace-nowrap flex items-center gap-3 group hover:bg-[#F3F4F6] dark:hover:bg-gray-900 bg-white dark:bg-black"
                      onClick={() => {
                    ...
                    >
                      <div
                        className={`${size.icon} w-5 h-5 text-[#6B7280] dark:text-gray-400 group-hover:text-black group-hover:dark:text-white transition-colors duration-200`}
                      />
                      <div className="flex-grow flex flex-col">
                        <span className="font-medium group-hover:text-black group-hover:dark:text-white transition-colors duration-200">
                          {size.name}
                        </span>
                        <span className="text-xs text-[#6B7280] dark:text-gray-400 group-hover:text-black group-hover:dark:text-white transition-colors duration-200">
