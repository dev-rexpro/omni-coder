...
const sliderOptions: SliderOptions<WorkbenchViewType> = {
  left: {
    value: 'code',
    text: 'Code',
    tooltip: 'View Editor Code',
  },
  middle: {
    value: 'diff',
    text: 'Diff',
    tooltip: 'View Code Differences',
  },
  right: {
    value: 'preview',
    text: 'Preview',
    tooltip: 'View Application Preview',
  },
};
                  ...
                  <div className="p-2">
                    <div className="relative mx-2 mb-2">
                      <input
                        ...
                        className="w-full pl-8 pr-3 py-1.5 text-sm rounded-lg bg-bolt-elements-background-depth-1 border border-bolt-elements-borderColor focus:outline-none focus:border-bolt-elements-focus transition-colors"
                      />
            ...
            <div className="absolute inset-0 px-2 lg:px-4">
              <div className="h-full flex flex-col bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor shadow-sm rounded-lg overflow-hidden">
                <div className="flex items-center px-3 py-2 border-b border-bolt-elements-borderColor gap-1.5">
                  <WithTooltip tooltip={showChat ? 'Hide Chat' : 'Show Chat'}>
                    <button
                  ...
                  {selectedView === 'code' && (
                    <div className="flex overflow-y-auto">
                      ...
                      <div className="flex border border-bolt-elements-borderColor rounded-md overflow-hidden ml-1">
                        <DropdownMenu.Root>
                          <WithTooltip tooltip="Sync Local Folder">
                            <DropdownMenu.Trigger
                              disabled={isSyncing || streaming}
                              className="rounded-md items-center justify-center [&:is(:disabled,.disabled)]:cursor-not-allowed [&:is(:disabled,.disabled)]:opacity-60 px-3 py-1.5 text-xs font-medium bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors outline-[var(--primary)] flex gap-1.7"
                            >
                      ...
                      <div className="flex border border-bolt-elements-borderColor rounded-md overflow-hidden ml-1">
                        <WithTooltip tooltip="Toggle Terminal Panel">
                          <button
                            onClick={() => {
