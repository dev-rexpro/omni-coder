        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              className={classNames(
                ...
                'text-bolt-elements-textPrimary',
                'focus:outline-none focus:border-bolt-elements-focus transition-colors',
              )}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-bolt-elements-textPrimary text-sm rounded-lg bg-white dark:bg-bolt-elements-background-depth-4 border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor-dark focus:outline-none focus:border-bolt-elements-focus transition-colors"
            />
          </div>
