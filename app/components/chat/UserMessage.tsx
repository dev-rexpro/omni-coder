...
export function UserMessage({ content, parts }: UserMessageProps) {
  ...
  if (Array.isArray(content)) {
    ...
    return (
      <div className="overflow-hidden flex flex-col gap-3 items-center ">
        ...
        <div className="flex flex-col gap-4 bg-[var(--muted)] backdrop-blur-sm p-3 py-3 w-auto rounded-lg mr-auto">
  ...
  return (
    <div className="flex flex-col bg-[var(--muted)] backdrop-blur-sm px-5 p-3.5 w-auto rounded-lg ml-auto">
