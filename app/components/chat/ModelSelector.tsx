      ...
      <div className="relative flex w-full" onKeyDown={handleProviderKeyDown} ref={providerDropdownRef}>
        <div
          className={classNames(
            'w-full p-2 rounded-md border border-bolt-elements-borderColor',
            'bg-bolt-elements-prompt-background text-bolt-elements-textPrimary',
            'outline-none focus:outline-none focus-visible:outline-none focus-within:outline-none focus-within:border-bolt-elements-focus',
            'cursor-pointer',
            isProviderDropdownOpen ? 'border-bolt-elements-focus' : undefined,
          )}
      ...
      <div className="relative flex w-full min-w-[70%]" onKeyDown={handleModelKeyDown} ref={modelDropdownRef}>
        <div
          className={classNames(
            ...
            'outline-none focus:outline-none focus-visible:outline-none focus-within:outline-none focus-within:border-bolt-elements-focus',
            'cursor-pointer',
            isModelDropdownOpen ? 'border-bolt-elements-focus' : undefined,
          )}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-1 ml-2">
                        {isModelLikelyFree(modelOption, provider?.name) && (
                          <WithTooltip tooltip="Free model">
                            <span className="i-ph:gift text-xs text-purple-400" />
                          </WithTooltip>
                        )}
                        {model === modelOption.name && (
                          <WithTooltip tooltip="Selected">
                            <span className="i-ph:check text-xs text-green-500" />
                          </WithTooltip>
                        )}
                      </div>
                    </div>
