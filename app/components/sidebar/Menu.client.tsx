      ...
      >
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            <div className="flex gap-2">
              <WithTooltip tooltip="Start a New Chat">
                <a
                  href="/"
                  className="flex-1 flex gap-2 items-center bg-[color-mix(in_srgb,var(--primary),transparent_90%)] text-[var(--primary)] hover:bg-[color-mix(in_srgb,var(--primary),transparent_80%)] rounded-lg px-4 py-2 transition-colors"
                >
                  <span className="inline-block i-ph:plus-circle h-4 w-4" />
                  <span className="text-sm font-medium">Start new chat</span>
                </a>
              </WithTooltip>
              <WithTooltip tooltip={selectionMode ? 'Exit Selection Mode' : 'Enter Selection Mode'}>
                <button
            ...
            <div className="relative w-full">
              ...
              <input
                className="w-full bg-gray-50 dark:bg-gray-900 relative pl-9 pr-3 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-[var(--primary)] text-sm text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-500 border border-gray-200 dark:border-gray-800"
                type="search"
          ...
          <div className="flex items-center justify-between text-sm px-4 py-2">
            ...
            {selectionMode && (
              <div className="flex items-center gap-2">
                <WithTooltip tooltip={selectedItems.length === filteredList.length ? 'Deselect All Chats' : 'Select All Chats'}>
                ...
                <Button
                  ...
                  className="bg-red-500 hover:bg-red-600 text-white disabled:bg-red-500/50 disabled:text-white/60"
                >
                  Delete selected
                </Button>
              </div>
