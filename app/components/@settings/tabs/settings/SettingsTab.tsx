...
export default function SettingsTab() {
  ...
  return (
    <div className="space-y-4">
        ...
        <div>
          ...
          <select
            ...
            className={classNames(
              ...
              'focus:outline-none focus:ring-2 focus:ring-bolt-elements-focus/30',
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          <div className="i-ph:clock-fill w-4 h-4 text-bolt-elements-textSecondary" />
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          <div className="i-ph:keyboard-fill w-4 h-4 text-bolt-elements-textSecondary" />
