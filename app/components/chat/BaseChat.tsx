      ...
      >
        ...
        <div className="flex flex-col lg:flex-row overflow-y-auto overflow-x-hidden w-full h-full">
          <div className={classNames(styles.Chat, 'flex flex-col flex-grow lg:min-w-[var(--chat-min-width)] h-full overflow-x-hidden')}>
            ...
            {!chatStarted && (
              <div className="flex flex-col justify-center flex-shrink-0 pb-8 sm:pb-12">
  ...
  return (
    !isAtBottom && (
      <>
        ...
        <button
          className="sticky z-1 bottom-0 left-0 right-0 text-4xl rounded-lg px-1.5 py-0.5 flex items-center justify-center mx-auto gap-2 bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor text-bolt-elements-textPrimary text-sm"
