  ...
  return (
    <>
      <div className="flex border border-bolt-elements-borderColor rounded-md overflow-hidden text-sm">
        <DropdownMenu.Root>
          <WithTooltip tooltip="Deploy Application">
          ...
          >
            ...
            >
              <img
                ...
                alt="vercel"
              />
              <span className="flex-1 text-left">{!vercelConn.user ? 'No Vercel Account Connected' : 'Deploy to Vercel'}</span>
            ...
            >
              <img
                ...
                alt="gitlab"
              />
              <span className="flex-1 text-left">{!gitlabIsConnected ? 'No GitLab Account Connected' : 'Deploy to GitLab'}</span>
            </DropdownMenu.Item>
